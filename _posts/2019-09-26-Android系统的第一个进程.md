1. ---
1. layout:     post
1. title:      "Android系统的第一个进程"
1. subtitle:   "read the fxxking source code"
1. date:       2019-09-26 12:00:00
1. author:     "GuoHao"
1. header-img: "img/waittouse.jpg"
1. catalog: true
1. tags:
1.     - Android
1.     - 源码
...
```
ForEachServiceInClass 会遍历上述的 service 链表，找到 classname 为 main 的 zygote 后，执行 StartIfNotDisabled 函数去启动 zygote。  
